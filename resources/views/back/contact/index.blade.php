                      ...
                      <tr class="text-center" >
                        ...
                        <td>
                          <div style="display: inline-flex;">
                            ...
                            <form action="{{ route('contact.destroy', $contacts) }}" method="post">
                              @csrf
                              @method('DELETE')
                              <button type="submit" rel="tooltip" class="btn  btn-linght btn-round" onclick="return confirm('Est tu sur de vouloir supprimer cette dema,de ?')">
