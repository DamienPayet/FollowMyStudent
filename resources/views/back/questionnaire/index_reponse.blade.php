            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        @endif
                        <button data-href="/download" id="export" style='margin-right:10px;'
                                class="btn btn-success btn-sm" onclick="exportTasks(event.target);"><i
                                class="fas fa-edit"></i> Exporter les données
                        </button>
                        <script>
                                    ...
                                    <div class="card-body">
                                        <div class="card">
                                            <div class="card-header card-header-primary">
                                                ...
                                                <h4 class="card-title "
                                                    style="text-align: center">{{$question->question}}</h4>
                                                <!--Bouton deroulement de la section -->
                                                <div id="btn_more_{{$question->id}}">
                                                    <button onclick="down({{$question->id}})"
                                            ...
                                            @foreach($question->reponses as $rep)
                                                ...
                                                <div id="menu_{{$question->id}}" style="display : none"
                                                     class="card-body">
                                                    <br/> <br/>
