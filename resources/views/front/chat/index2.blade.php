...
@section('content')
	...
	<div class="section section-pagination">
		<div class="container">
			<h3 class="title">FollowMyStudent</h2>
				...
				<div class="row flex-row">
					<div class="col-lg-4">
												...
												<div class="media-body ml-2">
													<div class="justify-content-between align-items-center">
														@if($utilisateur->statut == "eleve")
															<h6 class="mb-0">{{$utilisateur->eleve->nom}} {{$utilisateur->eleve->prenom}}
															@else
																<h6 class="mb-0">{{$utilisateur->admin->nom}} {{$utilisateur->admin->prenom}}
																@endif
						...
						<div class="col-lg-8">
							<div id="mywindow" class="card card-plain">
										...
										<div class="col-md-10">
											<div class="media align-items-center">
												...
												<div class="media-body">
													...
													<span class="text-muted text-small">OffLine</span>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card-footer d-block">
									<div class="align-items-center">
										<div class="input-group d-flex">
											...
											<input type="text" id="msg"  onKeyPress="if (event.keyCode == 13) send()" class="form-control form-control-lg" placeholder="Your message">
			...
			function viewmessage(response) {
				...
				for (var i = 0; i < messages.length; i++) {
					...
					if (messages[i].sender == usr.id) {
						...
						div	+='	<div>';
						div	+='	<small class="opacity-60">3:30am</small>';
						...
						div+='<div><small class="opacity-60"><i class="far fa-clock"></i> 3:14am</small>';
						div+='</div>';
						div+='</div>';
						div+='</div>';
						div+='</div>';
