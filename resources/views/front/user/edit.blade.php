              ...
              <form method="post" action="{{ route('front.users.update', $user) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="row avatar">
                  ...
                  <div class="col-sm-7 text-center">
                    <div class="form-group" style="width: 110px; height: 100px;">
                      <img class="text-center form-control" name="image_profil" id="input-image_profil" src="{{url($user->image_profil)}}" value="{{$user->image_profil}}" required="true" aria-required="true">
                ...
                <div class="row avatar">
                  ...
                  <div class="col-sm-7 text-center">
                    ...
                    <div class="col-sm-15 text-center">
                      ...
                      <input id="av_image" type="file" class="form-control" name="av_image">
                    </div>
                    <br>
                    <!--for preview purpose -->
                    <!--
